...
enum fail_state {SHOULD_WORK = 0, SCANNER_SHOULD_FAIL = 1, PARSER_SHOULD_FAIL = 2};
...
int main(int argc, char * argv[]) {
    ...
    }
    {
        ...
        test_cases_successful += main_test_loop("f(x,y) hallo : hallo : hallo : $10; end;", SHOULD_WORK);
        test_cases_executed += 1;
    }
    {
    ...
    }
    {
        ...
        test_cases_successful += main_test_loop("f(x,y) return $10; goto hallo; if 1 goto hallo; var hallo = 1; hallo = $1; $1[$1] = $1[$1]; end;", SHOULD_WORK);
        test_cases_executed += 1;
    }
    {
    ...
    }
    {
        ...
        test_cases_successful += main_test_loop("f(x,y) return 10; return hallo[5]; return hallo(a,b,c); return hallo{a,b,c,d}; return hallo@(a,b,c,d,e);  end;", SHOULD_WORK);
        test_cases_executed += 1;
    }
    {
...
int main_test_loop(char * input, int fail_case) {
    ...
    switch(pid) {
        ...
        case 0:
            ...
            char * path_string = "../../../abgabe/parser/parser";
            execlp(path_string, "parser", NULL);
        ...
        default:
            ...
            if (ret == 1) {
                fprintf(stdout, "Test case successful with input: %s \n", input);
                ret = 1;
            } else {
